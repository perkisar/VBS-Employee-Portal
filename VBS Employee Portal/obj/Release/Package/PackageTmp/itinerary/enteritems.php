            ...
            <form action="" method="POST">
                <div class="col-md-6">
                    ...
                    <select required id="acctType" name="acctType">
                        ...
                        <option id="coldCall" name="acctType" value="Cold Call">Cold Call</option>
                ...
                <div class="col-md-6">
                    ...
                    <input required type="text" id="prospect" name="prospect" placeholder="Prospect" /><br />
...
$order = "INSERT INTO $table (name, day, acctType, acctName, location, prospect, notes) VALUES ('$name', '$day', '$acctType', '$acctName', '$location', '$prospect', '$notes')";
